...
const TrophyIcon
 = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M10 14.66V16.286C9.99622 16.6286 9.90448 16.9645 9.73358 17.2615C9.56268 17.5585 9.31834 17.8066 9.024 17.982C8.39914 18.4448 7.89084 19.047 7.53948 19.7406C7.18813 20.4343 7.00341 21.2004 7 21.978"
      stroke="white"
      strokeWidth={2}
      strokeLinecap="round"
    ...
    />
    <path
      d="M14 14.66V16.286C14.0038 16.6286 14.0955 16.9645 14.2664 17.2615C14.4373 17.5585 14.6817 17.8066 14.976 17.982C15.6009 18.4448 16.1092 19.047 16.4605 19.7406C16.8119 20.4343 16.9966 21.2004 17 21.978"
      stroke="white"
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
